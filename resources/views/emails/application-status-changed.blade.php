        ...
        <tr>
            <td style="padding:24px;">
                <h2 style="margin:0 0 16px 0;font-size:22px;line-height:1.3;">
                    {{ __('Application Status Update') }}
                </h2>

                <p style="margin:0 0 14px 0;">
                    {{ __('Hello :name,', ['name' => $notifiable->name ?? __('there')]) }}
                </p>

                <p style="margin:0 0 18px 0;">
                    {{ __('The employer updated your application status.') }}
                </p>
                ...
                <div
                    ...
                    <p style="margin:0 0 8px 0;">{{ __('Company: :company', ['company' =>
                        $application->job->employer->name]) }}</p>
                    <p style="margin:0;">
                        {{ __('New status:') }}
                        <span
                            style="display:inline-block;padding:4px 10px;border-radius:999px;font-size:12px;font-weight:700;background:{{ $statusStyles['bg'] }};color:{{ $statusStyles['text'] }};border:1px solid {{ $statusStyles['border'] }};">
                ...
                <p style="margin:0 0 18px 0;">
                    {{ __('You can review your applications from your dashboard.') }}
                </p>
                ...
                <p style="margin:0 0 14px 0;">
                    {{ __('If you have questions, reply to this email and our team will help.') }}
                </p>
